...
if osh == [1 0 0]    
    winopen Common/TOOTSEA.pdf;    
elseif osh == [0 1 0]    
    system('xdg-open TOOTSEA.pdf');   
elseif osh == [0 0 1]      ;
    system('open TOOTSEA.pdf');        
end

% --------------------------------------------------------------------
function contacts_Callback(hObject, eventdata, handles)
str={'';...
'Tools for Time Series Exploration and Analysis';...
'';...
'Please report bugs to : kevin.balem@ifremer.fr';...
