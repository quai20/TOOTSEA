...
%            Gph(nc0,L) or Gph(nc0,N,M) - Greenvich phase (o)
...
%
% 1/02/2012 : Modif. CK
% En matlab 2012, interp2 plante car mz est une matrice de logique.
% En matlab 2010, ca passait.
% On transforme mz de logique en double.
%
mz = double(mz);
% Fin modif. CK.
